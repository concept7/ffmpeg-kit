Pod::Spec.new do |s|  
    ...
    s.homepage          = "https://github.com/concept7/ffmpeg-kit-react-native"
    ...
    s.source            = { :http => "https://github.com/concept7/ffmpeg-kit-react-native/releases/download/vVERSION/ffmpeg-kit-https-gpl-VERSION-macos-framework.zip" }
