...
<img src="https://github.com/concept7/ffmpeg-kit-react-native/raw/main/docs/assets/ffmpeg-kit-icon-v9.png" width="180">
...
applications and 8 prebuilt binary packages available at [Github](https://github.com/concept7/ffmpeg-kit-react-native/releases),
...
- 8 prebuilt binary packages available at [Github](https://github.com/concept7/ffmpeg-kit-react-native/releases), [Maven Central](https://search.maven.org), [CocoaPods](https://cocoapods.org), [pub](https://pub.dev) and [npm](https://www.npmjs.com)
- Licensed under `LGPL 3.0`, or `GPL v3.0` if GPL licensed libraries are enabled

### 2. Android

See [Android](https://github.com/concept7/ffmpeg-kit-react-native/tree/development/android) to learn more about `FFmpegKit` for
`Android`.

### 3. iOS, macOS, tvOS

See [Apple](https://github.com/concept7/ffmpeg-kit-react-native/tree/development/apple) to use `FFmpegKit` on `Apple` platforms
(`iOS`, `macOS`, `tvOS`).

### 4. Flutter

See [Flutter](https://github.com/concept7/ffmpeg-kit-react-native/tree/main/flutter/flutter) to learn more about `FFmpegKit` for
`Flutter`.

### 5. React Native

See [React Native](https://github.com/concept7/ffmpeg-kit-react-native/tree/main/react-native) to learn more about `FFmpegKit` for
`React Native`.
...
[Building](https://github.com/concept7/ffmpeg-kit-react-native/wiki/Building) wiki page for the details.
...
[Github](https://github.com/concept7/ffmpeg-kit-react-native/releases),
...
| :--------------: | :-------------------------------------------------------------------------------------------: | :------------: | :----------: |
|     Flutter      |   [4.5.1](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/flutter.v4.5.1)    |  4.5-dev-3393  | Jan 02, 2022 |
|   React Native   | [4.5.1](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/react.native.v4.5.1) |  4.5-dev-3393  | Jan 02, 2022 |
|     Android      |       [4.5.1](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/v4.5.1)        |  4.5-dev-3393  | Jan 01, 2022 |
|      Apple       |       [4.5.1](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/v4.5.1)        |  4.5-dev-3393  | Dec 30, 2021 |
|     Flutter      |   [4.5.0](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/flutter.v4.5.0)    |  4.5-dev-2008  | Oct 05, 2021 |
|   React Native   | [4.5.0](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/react.native.v4.5.0) |  4.5-dev-2008  | Oct 01, 2021 |
| Android<br>Apple |         [4.5](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/v4.5)          |  4.5-dev-2008  | Sep 18, 2021 |
| Android<br>Apple |         [4.4](https://github.com/concept7/ffmpeg-kit-react-native/releases/tag/v4.4)          |  4.4-dev-3015  | Mar 03, 2021 |
...
A more detailed documentation is available under [Wiki](https://github.com/concept7/ffmpeg-kit-react-native/wiki).
